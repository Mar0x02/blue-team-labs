...
Dokumentasi perjalanan belajar Blue Team & SOC Analyst — berisi writeup challenge dan lab dari berbagai platform.

> Bahasa: Bahasa Indonesia | Istilah cybersecurity tetap dalam Bahasa Inggris
...
| [ILOVEYOU](./BTLO/ILOVEYOU/) | BTLO | Malware Analysis | Medium | ✅ | 2026-05-19 |
...
| [Ramnit Lab](./CyberDefenders/Ramnit%20Lab/) | CyberDefenders | Endpoint Forensics | Easy | ✅ | 2026-08-11 |
| [The Crime Lab](./CyberDefenders/The%20Crime%20Lab/) | CyberDefenders | Endpoint Forensics | Easy | ✅ | 2026-08-11 |
...
| [Extracted](./TryHackMe/Extracted/) | TryHackMe | Digital Forensics / Network Forensics / Malware Analysis | Medium | ✅ | 2026-06-22 |
...
### 🔵 [BTLO — Blue Team Labs Online](./BTLO/)

Platform berbasis investigasi dan incident response. Setiap lab mensimulasikan insiden nyata dengan artifact yang harus dianalisis.
...
| [Secrets](./BTLO/Secrets/) | Cryptography / Web Security | Easy | ✅ |
...
| [ILOVEYOU](./BTLO/ILOVEYOU/) | Malware Analysis | Medium | ✅ |
...
Platform blue team dengan skenario forensik dan threat hunting berbasis PCAP, memory dump, dan log analysis.

| Challenge | Category | Difficulty | Status |
|-----------|----------|------------|--------|
| [BlackEnergy Lab](./CyberDefenders/BlackEnergy%20Lab/) | Endpoint Forensics | Medium | 🔄 |
| [OpenWire Lab](./CyberDefenders/OpenWire%20Lab/) | Network Forensics | Medium | ✅ |
...
Learning path structured — saat ini fokus di **SOC Level 1**.

| Module | Category | Status |
|--------|----------|--------|
| [Extracted](./TryHackMe/Extracted/) | Digital Forensics / Network Forensics / Malware Analysis | ✅ |
...
| NetworkMiner | Network forensics & artifact extraction |
| MFTECmd | NTFS MFT & $J record parsing |
| Timeline Explorer | Visualisasi forensic timeline |
| olevba / oletools | Analisis macro VBA |
| Snort | Network IDS / packet analysis |
| VirusTotal | IOC lookup & file reputation |
| CyberChef | Decoding, deobfuscation, data transformation |
...
*Repo ini bagian dari perjalanan belajar menuju Blue Team / SOC Analyst.*